...
/-Subset of nowhere dense sets is nowhere dense-/
...
/-Union of nowhere dense sets is nowhere dense-/
...
/-Finite union of nowhere dense (singleton) sets is nowhere dense
  This is useful for no_isolated_imp_finite_nowhere_dense -/
...
/-If the metric space has no isolated points, all finite sets are nowhere dense-/
...
/-Subset of a meager set is meager-/
...
/-union of meager sets is meager-/
...
/-The countable union of meager sets is meager-/
...
Baire Space is a space where for all sets A∈X, Aᶜ meager → A Dense
-/
...
/-
Equivalent Characterization:
Baire Space is a space where all sequences of dense, open sets have dense intersection
-/
...
/-Decreasing Chains of closed sets have singleton intersection in complete metric spaces-/
